...
float4 main(VertexToPixel input) : SV_TARGET
{
	...
	float3 finalDLColor =
		diffuse * lightIntensity * lightColor * surfaceColor.rgb +
	...
	// NOTE: Explicitely NOT tinting specular by surface color here
	float3 finalPLColor =
		pl_diffuse * pointLightIntensity * pointLightColor * surfaceColor.rgb +
	...
	float3 totalLight = environmentAmbientColor * surfaceColor.rgb + finalDLColor + finalPLColor;
